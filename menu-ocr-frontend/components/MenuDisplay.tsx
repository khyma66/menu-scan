...
interface MenuDisplayProps {
  items: MenuItem[];
  // Health recommendations removed - no longer used
}
      ...
      <div>
        ...
        <div className="space-y-3 max-h-[400px] overflow-y-auto">
          {items.map((item, index) => (
            <div
              key={index}
              className="border border-gray-200 rounded-lg p-4 bg-gradient-to-r from-blue-50 to-purple-50 transition hover:shadow-md"
            >
